...
import "@/assets/scss/modules/_news-home.scss";
...
function TabPanel(props: TabPanelProps) {
    ...
    return (
        <div id={`news-tabpanel-${index}`} role="tabpanel" hidden={value !== index}
...
function a11yProps(index: number) {
    return {
        id: `news-tab-${index}`,'aria-controls': `news-tab-${index}`,
    };
}
...
function NewsSection() {
    ...
    return (
        <Box component="section" id="news" className="section sc-news">
                    ...
                    <Box className="sc-body">
                        <Box className="tab-head">
                            ...
                            >
                                ...
                                <Tab label="ข่าวประชาสัมพันธ์" className="tab" {...a11yProps(1)} />
                                <Tab label="ข่าวรับสมัครงาน" className="tab" {...a11yProps(2)} />
                                <Tab label="ข่าวจัดซื้อจัดจ้าง" className="tab" {...a11yProps(3)} />
                                <Tab label="ข่าวประกาศต่างๆ" className="tab" {...a11yProps(4)} />
                            </Tabs>
                        ...
                        <Box className="tab-content"  data-aos="fade-up">
                            <TabPanel value={value} index={0}>
                                                    ...
                                                    <Box className="content">
                                                        <div className="info-date-view">
                                                            <div className="list">
                                                                ...
                                                                <small className="txt">{slide.date}</small>
                                                            </div>
                                                            <div className="list">
                                                                <span className="icon">
                                                                ...
                                                                <small className="txt">{slide.view}</small>
                                                            </div>
                                                        </div>
                                                        <Typography variant="h3" className="h4 title text-limit">
                                ...
                                <div className="col">
                                    <ul className="sc-news-list">
                                        {slidesList.map((list) => (
                                            <li key={list.id}>
                                                <Link href={list.linkUrl} className="wrapper">
                                                    <Box className="thumb">
                                                        <Box component="figure" className="ratio">
                                                            <Image 
                                                                loader={imageLoader}
                                                    ...
                                                    <Box className="content">
                                                        <div className="info-date-view">
                                                            <div className="list">
                                                                ...
                                                                <small className="txt">{list.date}</small>
                                                            </div>
                                                            <div className="list">
                                                                <span className="icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="10.979" viewBox="0 0 16 10.979">
                                                                ...
                                                                <small className="txt">{list.view}</small>
                                                            </div>
                                                        </div>
                                                        <Typography variant="h3" className="h5 title text-limit">
                            ...
                            <TabPanel value={value} index={1}>
                                <div className="col">
                                    <Swiper
                                        ...
                                        modules={[Autoplay, Pagination, Navigation]}
                                        watchSlidesProgress={true}
                                        className="sc-news-swiper" data-aos="fade-in"
                                    >
                                        {slidesHilight.map((slide) => (
                                            <SwiperSlide key={slide.id}>
                                                <Link href={slide.linkUrl} className="wrapper">
                                ...
                                <div className="col">
                                    <ul className="sc-news-list">
                                        {slidesList.map((slide) => (
                                            <li key={slide.id} data-aos="fade-in">
                                                <Link href={slide.linkUrl} className="wrapper">
                                                    <Box className="thumb">
                                                        <Box component="figure" className="ratio">
                                                            <Image 
