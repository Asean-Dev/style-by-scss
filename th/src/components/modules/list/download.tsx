...
// types
import type {LayoutListDownload} from "@/types/list";

type Props = {
    ListDownload: LayoutListDownload[],
}

export default function LayoutListDownload({ ListDownload }: Props) {
    return (
        <>
                        ...
                        <li key={item.id} className="fluid">
                            <div className="wrapper">
                                ...
                                <div className="action">
                                    ...
                                    {item.btn &&(
                                        <Link href={`${item.btnUrl ?? '#'}`} className="btn btn-secondary" title={item.btn}>
                                            <div className="ic">
