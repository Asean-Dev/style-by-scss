...
type Props = {
    listItemDownloadThumb: LayoutListDownloadThumb[],
}

export default function LayoutItemDownloadThumb({ listItemDownloadThumb }: Props) {
    return (
        <>
            <div className="layout-item-thumb layout-download">
                <ul className="item-list">
                    {listItemDownloadThumb.map((item) => (
                            ...
                            <div className="wrapper">
                                ...
                                {item.iconlist &&(
                                    <div className="icon-item">
                                        {item.iconlist.map((icon) => (
                                            <div key={icon.id} className={`icon ${icon.iconType}`}>
                                                {icon.iconType === 'pdf' && (
                                                    <IconPdf/>
                                                )}
                                                {icon.iconType === 'doc' && (
                                ...
                                <div className="content">
                                    ...
                                    <div className="box">
                                        ...
                                        {item.case && (
                                            <div className="item case">{item.case}</div>
                                        )}
                                        {item.tag && (
