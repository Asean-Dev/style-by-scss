...
// types
import {LayoutListAccordionGroup} from "@/types/list";

type Props = {
    ListAccordionGroup: LayoutListAccordionGroup[],
}

export default function LayoutItem({ ListAccordionGroup }: Props) {
    return (
        <>
            <div className="layout-item-accordion">
                {ListAccordionGroup.map((listItem) => (
                    <div key={listItem.id} className="box-item">
