...
// constant
import { SearchInformationSCHeadOverview } from "@/constant/index-overview";
import { SearchInformationOverviewItem } from "@/constant/index-overview";

export default function page_searchInformation_index() {
    useEffect(() => {
    ...
    return (
        <>
            <Box component="section" id="overview" className="section sc-overview">
                <OverviewSCHead OverviewSCHeader={SearchInformationSCHeadOverview}/>
                <Box className="sc-body">
                    <Container className="container">
                        <OverviewItems OverviewItem={SearchInformationOverviewItem} />
                        <Pagination/>
                    </Container>
                </Box>
            </Box>
