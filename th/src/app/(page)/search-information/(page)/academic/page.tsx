...
import SearchAcademicForm from "@/components/core/search-academic-form";
...
// constant
import { SearchInformationAcademicListSCHeadList } from "@/constant/index-list";
import { SearchInformationAcademicListItem } from "@/constant/index-list";
    ...
    return (
        <>
            <Box component="section" id="list" className="section sc-list">
                <ListSCHead ListSCHeader={SearchInformationAcademicListSCHeadList}/>
                    ...
                    <Container className="container">
                        <div className="layout-list">
                            <div className="layout-content">
                                <SearchAcademicForm/>
                                <ListFilterSearch3/>
                                <ListItemDownloadSearch listItemDownloadSearch={SearchInformationAcademicListItem} />
                                <Pagination/>
                            </div>
                        </div>
                    </Container>
