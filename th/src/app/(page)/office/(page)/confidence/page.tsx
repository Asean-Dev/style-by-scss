...
// constant
import { OfficeConfidenceSCHeadList } from "@/constant/index-list";
import { OfficeNavList } from "@/constant/index-list";
import { OfficeListItemBookConfidence } from "@/constant/index-list";
    ...
    return (
        <>
            <Box component="section" id="list" className="section sc-list">
                <ListSCHead ListSCHeader={OfficeConfidenceSCHeadList}/>
                    ...
                    <Container className="container">
                        <div className="layout-list">
                            ...
                            <div className="layout-content">
                                <ListHilightBook/>
                                <ListFilterSearch/>
                                <ListItemsBook ListItemBook={OfficeListItemBookConfidence} />
                                <Pagination/>
                            </div>
                        </div>
                    </Container>
