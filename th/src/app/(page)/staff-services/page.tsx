...
// constant
import { staffServicesSCHeadOverview } from "@/constant/index-overview";
import { staffServicesOverviewItem } from "@/constant/index-overview";

export default function page_staff_services_index() {
    useEffect(() => {
    ...
    return (
        <>
            <Box component="section" id="overview" className="section sc-overview">
                <OverviewSCHead OverviewSCHeader={staffServicesSCHeadOverview}/>
                <Box className="sc-body">
                    <Container className="container">
                        <OverviewItems OverviewItem={staffServicesOverviewItem} />
                    </Container>
                </Box>
            </Box>
        </>
