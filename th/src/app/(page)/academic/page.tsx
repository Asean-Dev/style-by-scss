...
// constant
import { AcademiSCHeadOverview } from "@/constant/index-overview";
import { AcademicOverviewItem } from "@/constant/index-overview";

export default function page_academic_index() {
    useEffect(() => {
    ...
    return (
        <>
            <Box component="section" id="overview" className="section sc-overview">
                <OverviewSCHead OverviewSCHeader={AcademiSCHeadOverview}/>
                <Box className="sc-body">
                    <Container className="container">
                        <OverviewItems OverviewItem={AcademicOverviewItem} />
                        <Pagination/>
                    </Container>
                </Box>
            </Box>
