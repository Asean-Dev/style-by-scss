...
import DetailItemsBook from "@/components/modules/detail/item-book";
...
import { AcademicDetailItemBook } from "@/constant/index-detail";
            ...
            <Box component="section" id="detail" className="section sc-detail">
                ...
                <Box className="sc-body">
                    <Container className="container">
                        ...
                        <DetailItemsBook ListItemBook={AcademicDetailItemBook} />
                    </Container>
                    <DetailOtherDownload/>
                </Box>
            </Box>
