...
import ListItemsAccordionGroup from "@/components/modules/list/item-accordion-group";
...
import { AdmincourtThingsToKnowMoldListItemList } from "@/constant/index-list";
                    ...
                    <Container className="container">
                        <div className="layout-list">
                            ...
                            <div className="layout-content">
                                ...
                                <ListItemsAccordionGroup ListAccordionGroup={AdmincourtThingsToKnowMoldListItemList} />
                            </div>
                        </div>
                    </Container>
                </Box>
