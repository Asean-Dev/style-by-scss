...
import { AdmincourtThingsToKnowJudicialProceedingsListItemList } from "@/constant/index-list";
                    ...
                    <Container className="container">
                        <div className="layout-list">
                            ...
                            <div className="layout-content">
                                ...
                                <ListItemsAccordion ListAccordion={AdmincourtThingsToKnowJudicialProceedingsListItemList} />
                            </div>
                        </div>
                    </Container>
                </Box>
