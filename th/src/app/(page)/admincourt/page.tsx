...
// constant
import { AdmincourtSCHeadOverview } from "@/constant/index-overview";
import { AdmincourtOverviewItem } from "@/constant/index-overview";

export default function page_admincourt_index() {
  useEffect(() => {
  ...
  return (
    <>
      <Box component="section" id="overview" className="section sc-overview">
        <OverviewSCHead OverviewSCHeader={AdmincourtSCHeadOverview} />
        <Box className="sc-body">
          <Container className="container">
            <OverviewItems OverviewItem={AdmincourtOverviewItem} />
            <Pagination />
          </Container>
        </Box>
      </Box>
