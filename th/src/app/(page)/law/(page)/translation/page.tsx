...
// constant
import { LawTranslationSCHeadList } from "@/constant/index-list";
import { LawNav } from "@/constant/index-list";
import { LawTranslationListItem } from "@/constant/index-list";
    ...
    return (
        <>
            <Box component="section" id="list" className="section sc-list">
                <ListSCHead ListSCHeader={LawTranslationSCHeadList}/>
                    ...
                    <Container className="container">
                        <div className="layout-list">
                            ...
                            <div className="layout-content">
                                <ListFilterSearch/>
                                <ListItemDownloadThumb listItemDownloadThumb={LawTranslationListItem} />
                                <Pagination/>
                            </div>
                        </div>
                    </Container>
