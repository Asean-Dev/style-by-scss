...
// constant
import { LawConsiderationSCHeadList } from "@/constant/index-list";
import { LawNav } from "@/constant/index-list";
import { LawConsiderationNav } from "@/constant/index-list";
import { LawConsiderationListItem } from "@/constant/index-list";
    ...
    return (
        <>
            <Box component="section" id="list" className="section sc-list">
                <ListSCHead ListSCHeader={LawConsiderationSCHeadList}/>
                    ...
                    <Container className="container">
                        <div className="layout-list">
                            ...
                            <div className="layout-content">
                                <ListFilterSearch/>
                                <ListItemsNav ListItemNav={LawConsiderationNav} />
                                <ListItemDownloadThumb listItemDownloadThumb={LawConsiderationListItem} />
                                <Pagination/>
                            </div>
                        </div>
                    </Container>
