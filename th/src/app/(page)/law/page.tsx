...
// constant
import { LawSCHeadOverview } from "@/constant/index-overview";
import { LawOverviewItem } from "@/constant/index-overview";

export default function page_law_index() {
    useEffect(() => {
    ...
    return (
        <>
            <Box component="section" id="overview" className="section sc-overview">
                <OverviewSCHead OverviewSCHeader={LawSCHeadOverview}/>
                <Box className="sc-body">
                    <Container className="container">
                        <OverviewItems OverviewItem={LawOverviewItem} />
                        <Pagination/>
                    </Container>
                </Box>
            </Box>
