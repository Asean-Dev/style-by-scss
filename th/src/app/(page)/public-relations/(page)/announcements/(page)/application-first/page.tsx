...
// constant
import { PublicRelationsAnnouncementsApplicationFirstSCHeadList } from "@/constant/index-list";
    ...
    return (
        <>
            <Box component="section" id="list" className="section sc-list">
                <ListSCHead ListSCHeader={PublicRelationsAnnouncementsApplicationFirstSCHeadList}/>
