...
import ListItemDownload from "@/components/modules/list/item-download";
...
// constant
import { PublicRelationsProcurementSCHeadList } from "@/constant/index-list";
import { PublicRelationsNav } from "@/constant/index-list";
import { PublicRelationProcurementHilight } from "@/constant/index-list";
import { PublicRelationProcurementTag } from "@/constant/index-list";
import { PublicRelationsProcurementListItem } from "@/constant/index-list";
    ...
    return (
        <>
            <Box component="section" id="list" className="section sc-list">
                <ListSCHead ListSCHeader={PublicRelationsProcurementSCHeadList}/>
                <Box className="sc-body">
                    <Container className="container">
                        <div className="layout-list">
                            <ListNav ListNav={PublicRelationsNav}/>
                            <div className="layout-content">
                                <ListHilight listHilight={PublicRelationProcurementHilight}/>
                                <ListFilterTags listFilterTags={PublicRelationProcurementTag}/>
                                <ListFilterSearch/>
                                <ListItemDownload ListItem={PublicRelationsProcurementListItem} />
                                <Pagination/>
                            </div>
                        </div>
                    </Container>
