...
import ListItemsGroupNumber from "@/components/modules/list/item-group-number";
...
// constant
import { PublicRelationsInformationSCHeadList } from "@/constant/index-list";
import { PublicRelationsNav } from "@/constant/index-list";
import { PublicRelationInformationTag } from "@/constant/index-list";
import { PublicRelationsInformationNav } from "@/constant/index-list";
import { PublicRelationsInformationListItem } from "@/constant/index-list";
    ...
    return (
        <>
            <Box component="section" id="list" className="section sc-list">
                <ListSCHead ListSCHeader={PublicRelationsInformationSCHeadList}/>
                <Box className="sc-body">
                    <Container className="container">
                        <div className="layout-list">
                            <ListNav ListNav={PublicRelationsNav}/>
                            <div className="layout-content">
                                <ListFilterTags listFilterTags={PublicRelationInformationTag}/>
                                <ListFilterSearch/>
                                <ListItemsNav ListItemNav={PublicRelationsInformationNav} />
                                <ListItemsGroupNumber ListItemGroupNumber={PublicRelationsInformationListItem} />
                                <Pagination/>
                            </div>
                        </div>
                    </Container>
